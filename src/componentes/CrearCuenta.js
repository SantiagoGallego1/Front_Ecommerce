  ...
  return (
      ...
      <h1 className="inline bg-gradient-to-r from-orange-200 via-orange-700 to-orange-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">
        ...
        >
         ...
         <Link
           className="block text-center my-5  py-3 bg-orange-800 text-white uppercase font-bold rounded hover:cursor-pointer hover:bg-orange-300 transition-colors"
         to={"/"}
         >
           Regresar
         </Link>
