...
const Home = () => {
  ...
  return (
   ...
   <div className='flex justify-center md:flex md:justify-between bg-orange-600'>
   <h1 className="inline p-8 bg-white bg-clip-text font-display text-5xl tracking-tight text-transparent">
      E-Commerce SOA
    </h1>
    <Link
           className="gap-4 flex flex-col items-center md:flex-row text-center my-5 text-white"
         to={"/login"}
         >
           Iniciar Sesión
         </Link>
   ...
   <div className="flex-1 bg-white">
    ...
    <div className="bg-gray-300">
      <div className="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        <h2 className="text-xl font-bold text-gray-900">productos de busqueda</h2>
          ...
          {productos.map((product) => (
            <div key={product.id}>
              ...
              <div className="mt-6">
                ...
                >
                  añadir al carrito<span className="sr-only">, {product.name}</span>
                </a>
              </div>
            </div>
          ))}
