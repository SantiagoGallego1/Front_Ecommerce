...
const Login = () => {
  ...
  return (
   ...
   <h1 className=" inline bg-gradient-to-r from-orange-200 via-orange-700 to-orange-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">
      Iniciar sesión Ecommerce SOA
    </h1>
    <form 
      onSubmit={onSubmit}
    ...
    >
      ...
      <Link
        className="block text-center  py-3 my-5 bg-orange-900 text-white uppercase font-bold rounded hover:cursor-pointer hover:bg-orange-500 transition-colors"
      to={"/crear-cuenta"}
      >
        Crear Cuenta
      </Link>
